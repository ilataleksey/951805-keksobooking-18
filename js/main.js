...
var mapActivation = function () {
  ...
  inputAddress.value = leftCoordinate + ', ' + (topCoordinate + Math.round(mapMainPin.offsetHeight / 2) + MAP_MAIN_PIN_EDGE);
...
var renderPin = function (accommodation) {
  ...
  pinElement.addEventListener('mousedown', function (evt) {
    evt.preventDefault();
    mapFilterContainer.appendChild(getCard(accommodation));
  });
...
var getCard = function (accommodation) {
  var fragment = document.createDocumentFragment();
